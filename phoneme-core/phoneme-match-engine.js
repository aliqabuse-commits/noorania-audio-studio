...
function buildStoredUnitRecordsForMatch(
  ...
  return units.map(function (unit) {
    ...
    const coordinates = {
      ...
      sealCentroid: base.sealCentroid ?? seal?.averageCentroid,
sealSpread: base.sealSpread ?? seal?.averageSpread,
sealBurstCentroid: base.sealBurstCentroid ?? seal?.averageBurstCentroid,
sealBurstSpread: base.sealBurstSpread ?? seal?.averageBurstSpread,
